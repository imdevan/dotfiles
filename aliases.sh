...
alias ssto="brew services stop sketchybar"
...
alias vg="v ~/dotfiles/config/stow/ghostty/.config/ghostty/config"
alias vzp="v ~/.zsh_profile"
...
alias hcl="dhc && looknfeel.conf"
alias hcb="dhc && bindings.conf"
alias hci="dhc && input.conf"
alias hcm="dhc && monitors.conf"
alias hcw="dhc && windows.conf"

# power
alias pwrl="powerprofilesctl list"
alias pwr="powerprofilesctl"
alias pwrp="powerprofilesctl set performance && powerprofilesctl get"
alias pwrb="powerprofilesctl set balanced && powerprofilesctl get"
alias pwrs="powerprofilesctl set power-saver && powerprofilesctl get"
...
# Shortcuts
alias gap.p="gap 'update presentation' && gco gh-pages && git push && gco master"
alias pr.rndp="open https://github.com/imdevan/react-native-dropdown-picker/compare/main...imdevan:react-native-dropdown-picker:main"
...
alias lov="~/dotfiles/functions/scripts/lovely.sh --favicon '/compy-guy.png'"
alias dp="cd ~/Documents/Projects/dance-partner"
alias oc="opencode"
alias pv="cd ~/Documents/Projects/dance-partner/dance-partner-vibes"
alias edpv="cd ~/Documents/Projects/dance-partner/dance-partner-vibes/app/expo"
alias bdpv="cd ~/Documents/Projects/dance-partner/dance-partner-vibes/app/backend"
alias bl="bun lint"
alias qpt="uv run pytest tests/test_database_setup.py::TestDatabaseConfiguration::test_database_uri_format -v" # Quick python test
alias db="harlequin -a sqlite app.db"
alias harkeys="harlequin --config-path ~/.harlequin.toml --profile default --keys"
...
alias tre="tms tr"
alias bad="bun add -d"
alias tas="v tasks.md"
alias ee="cd ./app/expo"
alias bb="cd ./app/backend"
alias sim="v plan/simple.md"
alias la="l -a"
