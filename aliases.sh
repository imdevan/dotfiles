...
alias igni="node ~/Documents/Projects/playground/ignite/ignite-clone/bin/ignite new"
alias ignig="node ~/Documents/Projects/playground/ignite/ignite-clone/bin/ignite generate"
